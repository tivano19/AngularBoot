...
export class HomeComponent implements OnInit, AfterViewInit {
    ...
    private openModal(rowId: number) {
        ...
        const modalRef = this._modalService.open(DetailPanelComponent);
        modalRef.componentInstance.title = 'Title: its me';
